...
```bash
uvx --from git+https://github.com/YOUR_USERNAME/openalex-mcp openalex-mcp
```
...
```bash
pip install git+https://github.com/YOUR_USERNAME/openalex-mcp
openalex-mcp
```
...
```json
{
  "mcpServers": {
    "openalex": {
      "command": "uvx",
      "args": ["--from", "git+https://github.com/YOUR_USERNAME/openalex-mcp", "openalex-mcp"],
      "env": {
